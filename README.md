...
Although it is known now that Bill Gates has never said that himself, whoever did, was probably close to the truth. How the resources in a system are used by the software is all that actually counts. Of course that assumes a system thought to properly utilise well written software...
