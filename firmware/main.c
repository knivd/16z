...
void main(void) {
    ...
    OSCCTL=0xe0;		// enable the external crystal oscillator
	{ int t; for(t=0; t<50000; t++); }	// delay for crystal oscialltor stabilisation
	OSCCTL=0xe7; OSCCTL=0x18;	// unlock the oscillator control
    OSCCTL=0xe1;		// select the external crystal oscillator

	PADD=0x9f; PBDD=0xff; PCDD=0x6b; PDDD=0x00; PEDD=0xff; PFDD=0x00; PGDD=0x00; PHDD=0x00; PJDD=0x66; PKDD=0x00;	// set port directions
	PAHDE=0x03; PBHDE=0xff; PCHDE=0x03;	// enable high drive current for GP0..GP11 pints
	PAAFL=0xf0; PCAFL=0x38; PDAFH=0xff; PFAFL=0xff; PGAFL=0xff; PHAFH=0x3; PKAFL=0xff;	// set port functions
